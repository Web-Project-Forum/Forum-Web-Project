...
CREATE TABLE IF NOT EXISTS `web_forum`.`replies` (
  ...
  INDEX `fk_replies_users1_idx` (`author_id` ASC),
...
CREATE TABLE IF NOT EXISTS `web_forum`.`topics` (
  ...
  INDEX `fk_topics_replies1_idx` (`best_reply_id` ASC),
...
CREATE TABLE IF NOT EXISTS `web_forum`.`permissions` (
  ...
  INDEX `fk_categories_has_users_users1_idx` (`users_id` ASC),
  INDEX `fk_categories_has_users_categories1_idx` (`categories_id` ASC),
